...
class ImageDescriptionGenerator:
    ...
    def __init__(self, config: dict):
        ...
        self.image_encoder = MoondreamChatHandler(
            clip_model_path=config["ENCODER_MODEL_PATH"]
        )
        self.llm = Llama(
    ...
    def check_image_url_permission(image_url: str) -> dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {
                    "is_accessible": False,
                    "message": "Permission denied: Access forbidden (403).",
                }
                ...
                return {
                    "is_accessible": False,
                    "message": f"HTTP error {response.status_code} occurred.",
                }
    ...
    def generate_image_description(self, image_url: str) -> str:
        ...
        response = self.llm.create_chat_completion(
            messages=[
                {
                    "role": "system",
                    "content": "You are an assistant who perfectly describe images.",
                },
                {
                    "role": "user",
                    "content": [
                        {
                            "type": "text",
                            "text": "Transform the following image into meaningful textual descrtipion: ",
                        },  # "Describe what is this flowgraph about step by step :"},
